  ...
  return (
    <>
      <button
        ...
        className="tactile pt-3 text-left text-xs italic text-texte-doux/70"
      >
        ...
        >
          ...
          >
            <div className="flex items-center justify-between">
              <span id="sources-rcp-titre" className="text-sm font-semibold text-texte">
                RCP consultés
              </span>
              <button
                type="button"
            ...
            <p className="mb-3.5 text-xs text-texte-doux/70">
            ...
            <ul className="flex flex-col">
              {sources.map((source, index) => (
                <li
                  ...
                  className={`py-2.5 text-sm text-texte ${
            ...
            {aPiedDePage && (
              <div className="mt-3 border-t border-texte/10 pt-3 text-xs text-texte-doux">
