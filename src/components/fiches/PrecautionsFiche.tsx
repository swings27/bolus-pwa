...
export default function PrecautionsFiche({
  ...
  return (
    ...
    >
      <span
        className="absolute -top-3 left-6 rounded-full px-2.5 py-1 text-[0.625rem] font-semibold uppercase tracking-wide"
        ...
        {grossesseAllaitement && (
          <GroupePrecaution icone={Baby} titre="Grossesse / Allaitement">
            <div className="flex flex-col gap-3 pb-1.5">
              <div>
                <span className="text-[0.6875rem] font-semibold uppercase text-texte-doux">Grossesse</span>
              ...
              <div>
                <span className="text-[0.6875rem] font-semibold uppercase text-texte-doux">Allaitement</span>
