...
export default function DisclaimerBanner() {
  return (
    <div
      ...
      style={{ backgroundColor: 'color-mix(in srgb, var(--texte) 6%, var(--fond))' }}
    >
      <Info className="mt-0.5 h-4 w-4 shrink-0 text-texte/70" aria-hidden="true" />
      <p className="text-xs leading-relaxed text-texte/70">
