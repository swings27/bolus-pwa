...
export const CATALOGUE_FICHES: Record<string, IFicheMeta> = {
  ...
  atosiban: { categorie: 'obstetrique', sousFamille: '' },
  atropine: { categorie: 'cardiovasculaire', sousFamille: 'Cardiotropes' },
  cefepime: { categorie: 'anti-infectieux', sousFamille: 'Antibiotiques' },
  ...
  fondaparinux: { categorie: 'cardiovasculaire', sousFamille: 'Anticoagulants' },
  ...
  lidocaine: { categorie: 'anesthesiques', sousFamille: 'Locaux' },
  metoclopramide: { categorie: 'gastrologie', sousFamille: 'Antiémétiques' },
  ...
  octreotide: { categorie: 'endocrinologie', sousFamille: 'Hormones' },
  ondansetron: { categorie: 'gastrologie', sousFamille: 'Antiémétiques'},
  oxytocine: { categorie: 'obstetrique', sousFamille: '' },
  ...
  rocuronium: { categorie: 'anesthesiques', sousFamille: 'Curares' },
  spiramycine: { categorie: 'anti-infectieux', sousFamille: 'Antibiotiques' },
  sufentanil: { categorie: 'anesthesiques', sousFamille: 'Analgésiques' },
  tramadol: { categorie: 'antalgiques', sousFamille: 'Antalgiques palier 2'},
  urapidil: { categorie: 'cardiovasculaire', sousFamille: 'Antihypertenseurs' },
